...
public class Socio implements Serializable {
    ...
    public Socio(String numeroSocio, String nombre, String dni, String fechaEntrada, String telefono, Character categoria, String correo){
        this.numeroSocio = numeroSocio;
        this.nombre = nombre;
        this.dni = dni;
        this.fechaEntrada = fechaEntrada;
    ...
    public String toString() {
        return "Numero Socio=" + numeroSocio +'\n' + "Nombre: " + nombre +'\n' + "DNI: " + dni +'\n' + "Categoria: " + categoria +'\n';
    }
